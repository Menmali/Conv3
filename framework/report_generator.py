...
def generate_charts(
    ...
    # --- Wrap long attribute lists (break after 3 attributes) ---
    ...
    ax3.axhline(mapping.borderline_threshold * 100, color=ORANGE,
                linestyle="--", linewidth=1.1, alpha=0.8)
    for bar, val in zip(bars, score_vals): # type: ignore
    ...
    verdict_short = {"sufficient": "SUFFICIENT", "borderline": "BORDERLINE",
    ...
    # Adjust layout to ensure nothing is cut off, especially the leftmost x-label
    plt.tight_layout()
